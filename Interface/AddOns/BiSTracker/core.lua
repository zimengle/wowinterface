			...
			for itemIndex = 1, table.getn(itemSlots) do
				...
				item:SetScript("OnEnter", function(self) 
					...
					if (tostring(itemMinLevel) ~= "nil") then
						...
						MainFrame.tip:AddLine("\n此物品发现于: " .. itemData[itemSlots[itemIndex]].Obtain.Zone);
						...
						if (string.len(itemData[itemSlots[itemIndex]].Obtain.Drop) > 0) then
							MainFrame.tip:AddLine("掉率: " .. itemData[itemSlots[itemIndex]].Obtain.Drop);
						else
						...
						if (string.len(itemData[itemSlots[itemIndex]].Obtain.Drop) > 0) then
							MainFrame.tooltipObtain.Drop:SetText("掉率: " .. itemData[itemSlots[itemIndex]].Obtain.Drop);
						else
...
MainFrame:SetScript("OnEvent", function(self, event, ...)
	...
	if event == "PLAYER_LOGIN" then
		...
		MainFrame.dropdownClass = createDropdown("职业", 10, -33, 75, 18);
		MainFrame.dropdownSpec = createDropdown("天赋", 90, -33, 75, 18);
		MainFrame.dropdownPhase = createDropdown("阶段", 170, -33, 75, 18);
