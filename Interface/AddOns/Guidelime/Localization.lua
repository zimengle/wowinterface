...
L.DETAILS = "描述"
L.AUTO_COMPLETE_QUESTS = "自动接取/提交任务"
L.MAIN_FRAME_WIDTH = "窗口宽度"
L.MAIN_FRAME_HEIGHT = "窗口高度"
L.MAIN_FRAME_ALPHA = "窗口透明度"
L.MAP_MARKERS_LOC = "额外箭头 (%s)"
L.LOCK_ARROW = "锁定箭头"
L.MAIN_FRAME_FONT_SIZE = "字体大小" 
L.SELECT_COLORS = "颜色"
...
L.MAP = "大地图"
L.MINIMAP = "小地图"
L.MAP_MARKER_ALPHA = "地图箭头透明度"
L.ARROW_ALPHA = "箭头透明度"
L.ARROW_STYLE = "箭头样式"
L.MAP_MARKERS_GOTO = "路径点标记 (%s)"
L.ARROW_STYLE1 = "lime"
L.ARROW_STYLE2 = "arrow"
...
L.DOWNLOAD_FULL_GUIDE = "这只是一个范本。要取得完整的 %s-%s 导航，需要安装 %s 模组，你可以在这里取得：%s"
L.GUIDE_LIST = "更多可用导航：%s"
L.AUTO_COMPLETE_QUESTS = "自动交接任务"
L.EDITOR = "编辑器"
L.SAVE_GUIDE = "储存导航"
L.AUTO_SELECT_FLIGHT = "自动选择一个鸟点"
...
L.STEP_FOLLOWUP_QUEST_CONT = "你可以之後再做 %s，這個任務的步驟會再度出現在导航裡。"
L.STEP_FOLLOWUP_QUESTS_CONT = "你可以之後再做 %s，這些任務的步驟會再度出現在导航裡。"
...
L.ADD_QUEST_COORDINATES_MESSAGE = "如果數據庫中有任務座標，將它們添加到所有步驟內；這會取代目前导航內的任務座標。"
