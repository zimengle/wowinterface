...
L["Show points of interest"] = "显示其他感兴趣的标记点"
L["Show flight points"] = "显示飞行鸟点"
L["Show boats, zeppelins and trams"] = "显示船点,飞艇点,地铁"
...
L["Icons"] = "图标"
L["If checked, boat harbors, zeppelin towers and tram stations will be shown on the world map."] = "勾选后，会在地图上显示船舶码头、飞艇塔楼和地铁站的相关位置。"
L["If checked, coordinates will be shown at the base of the world map."] = "勾选后，会在世界地图上显示坐标。"
L["If checked, dungeon and raid locations will be shown on the world map."] = "勾选后，会在世界地图上显示地下城和团队副本的入口。"
L["If checked, flight points, boat harbors, zeppelin towers and tram stations will be shown on the minimap."] = "勾选后，会在小地图上显示飞行点、船舶码头、飞艇塔楼以及地铁站。"
L["If checked, flight points, boat harbors, zeppelin towers and tram stations will be shown on the world map."] = "勾选后，会在世界地图上显示飞行点、船舶码头、飞艇塔楼以及地铁站。"
...
L["If checked, zone and dungeon levels will be shown on the world map."] = "勾选后，会在世界地图上显示各区域和副本的等级。"
...
L["Icons"] = "圖示"
L["If checked, boat harbors, zeppelin towers and tram stations will be shown on the world map."] = "勾選後，船舶港口、飛船塔以及電車站都會顯示在世界地圖上。"
L["If checked, coordinates will be shown at the base of the world map."] = "勾選後，座標將顯示在世界地圖底部。"
L["If checked, dungeon and raid locations will be shown on the world map."] = "勾選後，地下城與團隊副本位置會顯示在世界地圖上。"
L["If checked, flight points, boat harbors, zeppelin towers and tram stations will be shown on the minimap."] = "勾選後，飛行鳥點、船舶碼頭、飛艇塔樓以及電車站都會顯示在小地圖上。"
L["If checked, flight points, boat harbors, zeppelin towers and tram stations will be shown on the world map."] = "勾選後，飛行鳥點、船舶碼頭、飛艇塔樓以及電車站都會顯示在世界地圖上。"
...
L["If checked, zone and dungeon levels will be shown on the world map."] = "勾選後，區域與地下城等級會顯示在世界地圖上。"
...
L["Icons"] = "아이콘"
L["If checked, boat harbors, zeppelin towers and tram stations will be shown on the world map."] = "여객 항구, 비행선 타워 ,지하철역이 세계지도에 표시됩니다."
L["If checked, coordinates will be shown at the base of the world map."] = "좌표가 세계지도의 하단에 표시됩니다."
L["If checked, dungeon and raid locations will be shown on the world map."] = "던전과 공격대 위치가 세계지도에 표시됩니다."
L["If checked, flight points, boat harbors, zeppelin towers and tram stations will be shown on the minimap."] = "비행 지점, 여객 항구, 비행선 타워, 지하철역이 미니맵에 표시됩니다."
L["If checked, flight points, boat harbors, zeppelin towers and tram stations will be shown on the world map."] = "비행 지점, 여객 항구, 비행선 타워, 지하철역이 세계지도에 표시됩니다."
...
L["If checked, zone and dungeon levels will be shown on the world map."] = "지역과 던전의 레벨이 세계지도에 표시됩니다."
