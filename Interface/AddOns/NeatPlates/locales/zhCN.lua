...
L["Castbar Duration Style"] = "施法条持续时间风格"
	...
	L["Time Elapsed"] = "已消逝的时间"
	L["Time Elapsed/Cast Time"] = "已消逝的时间/施法时间"
L["CLASSIC_DURATION_SEC_PATTERN"] = "([0-9]+%.?[0-9]?)%s秒" -- Used to determine aura durations ex. in english it's '15 sec' or '15.5 sec' where the numbers are '([0-9]+%.?[0-9]?)', the white space between the word is '%s', and the suffix is 'sec'
L["CLASSIC_DURATION_MIN_PATTERN"] = "([0-9]+%.?[0-9]?)%s分" -- Used to determine aura durations ex. in english it's '15 min' or '15.5 min' where the numbers are '([0-9]+%.?[0-9]?)', the white space between the word is '%s', and the suffix is 'min'
L["Clear Spell Database"] = "清除法术数据库"
L["Cleared Spell Database of entries."] = "返回已清除的法术数据库"
L["Color Cast Bars by School"] = "由职业着色施法条颜色"
...
L["Shadow"] = "暗影"
L["Arcane"] = "奥术"
L["Range Indicator"] = "范围指示器"

L["Enable Range Indicator"] = "启用范围指示器"
L["Range Threshold"] = "范围阈值"
L["Scale based on distance"] = "根据距离缩放"
L["Outline Override"] = "轮廓覆盖"
	L["Thin Outline"] = "薄轮廓"
	L["Thick Outline"] = "粗轮廓"
L["Enforce required CVars"] = "强制要求CVars"
L["Threat & Highlighting"] = "仇恨 & 高亮"
L["Target Highlighting"] = "目标高亮"
L["Focus Highlighting"] = "焦点高亮"
L["Mouseover Highlighting"] = "鼠标悬停高亮"
	L["None"] = "无"
	L["Theme Default"] = "默认模板"
	L["Healthbar"] = "血条"
	L["Arrow(Top)"] = "上箭头"
	L["Arrow(Sides)"] = "侧箭头"
	L["Arrow(Right)"] = "右箭头"
	L["Arrow(Left)"] = "左箭头"
L["Range Indicator Colors"] = "范围指示器颜色"
	L["Melee Range"] = "近战范围"
	L["Close Range"] = "贴身范围"
	L["Mid Range"] = "中范围"
	L["Far Range"] = "远范围"
	...
	L["Simple"] = "简单"
	L["Advanced"] = "高级"
L["VERSION_WARNING_PROMPT_TEXT"] = [=[你似乎用错了版本，事情很可能无法正常工作。


在继续使用此插件之前，请确保你的版本正确。]=]
